...
- **ティッカー:** HMC
- **総供給量:** 1,000,000,000 HMC(固定供給・増刷不可・renounce済み)
- **decimals:** 9(Solana標準。※18はu64オーバーフローで不可)
...
| 運営・開発リザーブ | 200,000,000 HMC | 20% (12ヶ月リニア解放) |
| 初期エアドロップ・配布 | 300,000,000 HMC | 30% (6ヶ月リニア解放) |
